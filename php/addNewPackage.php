...
function debug_to_console($data) {
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $packagr_master_id=test_input($_POST["package_master_id"]);
 ...
 $sql_insert_login="INSERT INTO tbl_package_master (Package_name , Package_description, Package_img, Package_master_id, Package_price) VALUES ('$package_name', '$package_description', '$package_img' , '$package_master_id', '$package_price')";

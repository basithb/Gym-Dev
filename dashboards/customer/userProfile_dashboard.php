<?php
require_once('customerUserProfile.php');
?>
                    ...
                    <div class="row">
                        ...
                        <br>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action='customerUpdateProfile.php' method='POST'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group ml-3'>
                                                ...
                                                <input class="form-control" type="text" name="fname" 
                                                    placeholder="Enter Your First Name" value="<?php print_r($_SESSION['cust_fname']);?>">
                                            </div>

                                            <div class='form-group ml-3'>
                                                <label for="last_name">Last Name</label>
                                                <input class="form-control" type="text" name="lname" 
                                                    placeholder="Enter Your Last Name" value="<?php print_r($_SESSION['cust_lname']);?>">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group ml-3'>
                                                ...
                                                <input class="form-control" type="text" name="phone_no"
                                                    placeholder="Enter Your Phone Number" value="<?php print_r($_SESSION['cust_phone']);?>" >
                                            </div>

                                            <div class='form-group ml-3'>
                                                <label for="pin_code">Pin Code</label>
                                                <input class="form-control" type="text" name="cust_pincode"
                                                    placeholder="Enter Pin Code" value="<?php print_r($_SESSION['cust_pin']);?>">
                                            </div>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <input class="form-control" type="text" name="cust_address"
                                                placeholder="Enter Your Address" value="<?php print_r($_SESSION['cust_address']);?>">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group ml-3'>
                                                ...
                                                <input class="form-control" type="password" name="cust_password"

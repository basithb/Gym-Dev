        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="../../php/addCardDetails.php" method='POST'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group ml-3'>
                                                <label for="pin_code">Name on Card</label>
                                            ...
                                            <div class='form-group ml-3'>
                                                ...
                                                <input class="form-control" type="password" name="card_cvv"
            ...
            <div class="card border-secondary table-plain-bg">
                <div class="card-header">
                  <h4 class="card-title pb-2">Available Cards</h4>
                </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php   // LOOP TILL END OF DATA 
                                ...
                                $sql_fetch = "SELECT Card_number, Card_name, Expiry_date FROM tbl_card WHERE Customer_id='$customerid'";

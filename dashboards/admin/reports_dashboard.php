      ...
      <div class="content">
          ...
          <div class="col-md-13">
            <div class="card border-secondary table-plain-bg">
              <div class="card-header">
                <h4 class="card-title pb-2">Booking Reports</h4>
                <a class="btn btn-sm" href="print_bookingreports.php" target="_blank">
                  Print </a>
        ...
        <div class="container-fluid">
          <div class="col-md-13">
            <div class="card border-secondary table-plain-bg">
              <div class="card-header">
                <h4 class="card-title pb-2">Customer Reports</h4>
                <a class="btn btn-sm" href="print_customerreports.php" target="_blank">
                  Print </a>
              ...
              <div class="card-body table-full-width table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <?php print_r($row['Customer_id']);?>
                      </th>
                      <td>
                        <?php print_r($row['Username']);?>
                      </td>
                      <td>
                        <?php print_r($row['Customer_firstname']);?>
                      </td>
                      <td>
                        <?php print_r($row['Customer_lastname']);?>
                      </td>
                      <td>
                        <?php print_r($row['Customer_phonenumber']);?>
                      </td>
                      <td>
                        <?php print_r($row['Customer_address']);?>
                      </td>
                      <td>
                        <?php print_r($row['Customer_pin']);?>
                      </td>
        ...
        <div class="container-fluid">
          <div class="col-md-13">
            <div class="card border-secondary table-plain-bg">
              <div class="card-header">
                <h4 class="card-title pb-2">Trainer Reports</h4>
                <a class="btn btn-sm" href="print_trainerreports.php" target="_blank">
                  Print </a>
              </div>

...
$sql = "SELECT * FROM tbl_trainer WHERE Trainer_id='$trainer_id'";
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                ...
                <div class="container-fluid">
                    <a class="navbar-brand" href="#pablo">Edit Trainer Profile</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group ml-3'>
                                                ...
                                                <input class="form-control" type="text" name="fname" 
                                                    placeholder="Enter Your First Name" value="<?php echo ($_SESSION['trainer_fname']);?>">
                                            </div>
